...
class WeatherApp:
    ...
    def fetch_and_display_current_weather(self):
        ...
        # Fetch and plot historical weather data
        historical_data = self.fetch_historical_data(self.app_config, city=city)
    ...
    def plot_historical_data(self, data):
        ...
        plt.title ( f"Historical Temperature in {self.city_entry.get ()} over the Past Week" )
